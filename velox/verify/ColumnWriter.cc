...
namespace orc {
  ...
  public:
    ...
    virtual std::unique_ptr<BufferedOutputStream>
                    createStream(facebook::velox::dwrf::proto::orc::Stream_Kind kind) const override;
  private:
  ...
  std::unique_ptr<BufferedOutputStream> StreamsFactoryImpl::createStream(
                                                    facebook::velox::dwrf::proto::orc::Stream_Kind) const {
  ...
  ColumnWriter::ColumnWriter(
    ...
    std::unique_ptr<BufferedOutputStream> presentStream =
        factory.createStream(facebook::velox::dwrf::proto::orc::Stream_Kind_PRESENT);
    ...
    if (enableIndex) {
      rowIndex = std::unique_ptr<facebook::velox::dwrf::proto::orc::RowIndex>(new facebook::velox::dwrf::proto::orc::RowIndex());
      rowIndexEntry =
        std::unique_ptr<facebook::velox::dwrf::proto::orc::RowIndexEntry>(new facebook::velox::dwrf::proto::orc::RowIndexEntry());
      rowIndexPosition = std::unique_ptr<RowIndexPositionRecorder>(
                     new RowIndexPositionRecorder(*rowIndexEntry));
      indexStream =
        factory.createStream(facebook::velox::dwrf::proto::orc::Stream_Kind_ROW_INDEX);
    }
  }
  ...
  void ColumnWriter::flush(std::vector<facebook::velox::dwrf::proto::orc::Stream>& streams) {
    facebook::velox::dwrf::proto::orc::Stream stream;
    stream.set_kind(facebook::velox::dwrf::proto::orc::Stream_Kind_PRESENT);
  ...
  void ColumnWriter::createRowIndexEntry() {
    facebook::velox::dwrf::proto::orc::ColumnStatistics *indexStats = rowIndexEntry->mutable_statistics();
  ...
  void ColumnWriter::writeIndex(std::vector<facebook::velox::dwrf::proto::orc::Stream> &streams) const {
    // write row index to output stream
    rowIndex->SerializeToZeroCopyStream(indexStream.get());

    // construct row index stream
    facebook::velox::dwrf::proto::orc::Stream stream;
    stream.set_kind(facebook::velox::dwrf::proto::orc::Stream_Kind_ROW_INDEX);
    stream.set_column(static_cast<uint32_t>(columnId));
  ...
  public:
    ...
    virtual void flush(std::vector<facebook::velox::dwrf::proto::orc::Stream>& streams) override;

    virtual uint64_t getEstimatedSize() const override;
    virtual void getColumnEncoding(
      std::vector<facebook::velox::dwrf::proto::orc::ColumnEncoding>& encodings) const override;

    virtual void getStripeStatistics(
      std::vector<facebook::velox::dwrf::proto::orc::ColumnStatistics>& stats) const override;
    ...
    virtual void writeIndex(
      std::vector<facebook::velox::dwrf::proto::orc::Stream> &streams) const override;
  ...
  void StructColumnWriter::flush(std::vector<facebook::velox::dwrf::proto::orc::Stream>& streams) {
  ...
  void StructColumnWriter::writeIndex(
                      std::vector<facebook::velox::dwrf::proto::orc::Stream> &streams) const {
  ...
  void StructColumnWriter::getColumnEncoding(
                      std::vector<facebook::velox::dwrf::proto::orc::ColumnEncoding>& encodings) const {
    facebook::velox::dwrf::proto::orc::ColumnEncoding encoding;
    encoding.set_kind(facebook::velox::dwrf::proto::orc::ColumnEncoding_Kind_DIRECT);
  ...
  IntegerColumnWriter::IntegerColumnWriter(
    ...
    std::unique_ptr<BufferedOutputStream> dataStream =
      factory.createStream(facebook::velox::dwrf::proto::orc::Stream_Kind_DATA);
  ...
  void IntegerColumnWriter::flush(std::vector<facebook::velox::dwrf::proto::orc::Stream>& streams) {
    ColumnWriter::flush(streams);

    facebook::velox::dwrf::proto::orc::Stream stream;
    stream.set_kind(facebook::velox::dwrf::proto::orc::Stream_Kind_DATA);
    stream.set_column(static_cast<uint32_t>(columnId));
  ...
  void IntegerColumnWriter::getColumnEncoding(
    ...
    encoding.set_kind(rleVersion == RleVersion_1 ?
                                facebook::velox::dwrf::proto::orc::ColumnEncoding_Kind_DIRECT :
                                facebook::velox::dwrf::proto::orc::ColumnEncoding_Kind_DIRECT_V2);
    encoding.set_dictionarysize(0);
    encodings.push_back(encoding);
  }
  ...
  void ByteColumnWriter::flush(std::vector<facebook::velox::dwrf::proto::orc::Stream>& streams) {
    ColumnWriter::flush(streams);
  ...
  void BooleanColumnWriter::flush(std::vector<facebook::velox::dwrf::proto::orc::Stream>& streams) {
    ColumnWriter::flush(streams);
  ...
  void DoubleColumnWriter::flush(std::vector<facebook::velox::dwrf::proto::orc::Stream>& streams) {
    ColumnWriter::flush(streams);
  ...
  StringColumnWriter::StringColumnWriter(
    ...
    std::unique_ptr<BufferedOutputStream> lengthStream =
        factory.createStream(facebook::velox::dwrf::proto::orc::Stream_Kind_LENGTH);
  ...
  void StringColumnWriter::flush(std::vector<facebook::velox::dwrf::proto::orc::Stream>& streams) {
    ColumnWriter::flush(streams);

    facebook::velox::dwrf::proto::orc::Stream length;
    length.set_kind(facebook::velox::dwrf::proto::orc::Stream_Kind_LENGTH);
    length.set_column(static_cast<uint32_t>(columnId));
    length.set_length(lengthEncoder->flush());
    streams.push_back(length);

    facebook::velox::dwrf::proto::orc::Stream data;
    data.set_kind(facebook::velox::dwrf::proto::orc::Stream_Kind_DATA);
  ...
  TimestampColumnWriter::TimestampColumnWriter(
    ...
    std::unique_ptr<BufferedOutputStream> secondaryStream =
        factory.createStream(facebook::velox::dwrf::proto::orc::Stream_Kind_SECONDARY);
  ...
  void TimestampColumnWriter::flush(std::vector<facebook::velox::dwrf::proto::orc::Stream>& streams) {
    ColumnWriter::flush(streams);

    facebook::velox::dwrf::proto::orc::Stream dataStream;
    dataStream.set_kind(facebook::velox::dwrf::proto::orc::Stream_Kind_DATA);
    dataStream.set_column(static_cast<uint32_t>(columnId));
    dataStream.set_length(secRleEncoder->flush());
    streams.push_back(dataStream);

    facebook::velox::dwrf::proto::orc::Stream secondaryStream;
    secondaryStream.set_kind(facebook::velox::dwrf::proto::orc::Stream_Kind_SECONDARY);
  ...
  void Decimal64ColumnWriter::flush(std::vector<facebook::velox::dwrf::proto::orc::Stream>& streams) {
    ColumnWriter::flush(streams);
  ...
  void ListColumnWriter::flush(std::vector<facebook::velox::dwrf::proto::orc::Stream>& streams) {
    ColumnWriter::flush(streams);

    facebook::velox::dwrf::proto::orc::Stream stream;
    stream.set_kind(facebook::velox::dwrf::proto::orc::Stream_Kind_LENGTH);
    stream.set_column(static_cast<uint32_t>(columnId));
  ...
  void ListColumnWriter::writeIndex(std::vector<facebook::velox::dwrf::proto::orc::Stream> &streams) const {
    ColumnWriter::writeIndex(streams);
    if (child.get()) {
  ...
  void MapColumnWriter::flush(std::vector<facebook::velox::dwrf::proto::orc::Stream>& streams) {
    ColumnWriter::flush(streams);
  ...
  void UnionColumnWriter::flush(std::vector<facebook::velox::dwrf::proto::orc::Stream>& streams) {
    ColumnWriter::flush(streams);
  ...
  void UnionColumnWriter::writeIndex(std::vector<facebook::velox::dwrf::proto::orc::Stream> &streams) const {
    ColumnWriter::writeIndex(streams);
    for (uint32_t i = 0; i < children.size(); ++i) {
      children[i]->writeIndex(streams);
    }
