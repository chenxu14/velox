...
namespace orc {
  ...
  private:
    ...
    facebook::velox::dwrf::proto::orc::Footer fileFooter;
    facebook::velox::dwrf::proto::orc::PostScript postScript;
    facebook::velox::dwrf::proto::orc::StripeInformation stripeInfo;
    facebook::velox::dwrf::proto::orc::Metadata metadata;
  ...
  private:
    ...
    void buildFooterType(const Type& t, facebook::velox::dwrf::proto::orc::Footer& footer, uint32_t& index);
    static facebook::velox::dwrf::proto::orc::CompressionKind convertCompressionKind(
  ...
  void WriterImpl::writeStripe() {
    ...
    std::vector<facebook::velox::dwrf::proto::orc::Stream> streams;
    ...
    facebook::velox::dwrf::proto::orc::StripeFooter stripeFooter;
    for (uint32_t i = 0; i < streams.size(); ++i) {
      *stripeFooter.add_streams() = streams[i];
    }

    std::vector<facebook::velox::dwrf::proto::orc::ColumnEncoding> encodings;
    ...
    facebook::velox::dwrf::proto::orc::StripeStatistics* stripeStats = metadata.add_stripestats();
    std::vector<facebook::velox::dwrf::proto::orc::ColumnStatistics> colStats;
    ...
    for (uint32_t i = 0; i < streams.size(); ++i) {
      if (streams[i].kind() == facebook::velox::dwrf::proto::orc::Stream_Kind_ROW_INDEX) {
  ...
  void WriterImpl::buildFooterType(
                                   const Type& t,
                                   facebook::velox::dwrf::proto::orc::Footer& footer,
                                   uint32_t & index) {
    facebook::velox::dwrf::proto::orc::Type protoType;
    ...
    switch (t.getKind()) {
    case BOOLEAN: {
      protoType.set_kind(facebook::velox::dwrf::proto::orc::Type_Kind_BOOLEAN);
      break;
    }
    case BYTE: {
      protoType.set_kind(facebook::velox::dwrf::proto::orc::Type_Kind_BYTE);
      break;
    }
    case SHORT: {
      protoType.set_kind(facebook::velox::dwrf::proto::orc::Type_Kind_SHORT);
      break;
    }
    case INT: {
      protoType.set_kind(facebook::velox::dwrf::proto::orc::Type_Kind_INT);
      break;
    }
    case LONG: {
      protoType.set_kind(facebook::velox::dwrf::proto::orc::Type_Kind_LONG);
      break;
    }
    case FLOAT: {
      protoType.set_kind(facebook::velox::dwrf::proto::orc::Type_Kind_FLOAT);
      break;
    }
    case DOUBLE: {
      protoType.set_kind(facebook::velox::dwrf::proto::orc::Type_Kind_DOUBLE);
      break;
    }
    case STRING: {
      protoType.set_kind(facebook::velox::dwrf::proto::orc::Type_Kind_STRING);
      break;
    }
    case BINARY: {
      protoType.set_kind(facebook::velox::dwrf::proto::orc::Type_Kind_BINARY);
      break;
    }
    case TIMESTAMP: {
      protoType.set_kind(facebook::velox::dwrf::proto::orc::Type_Kind_TIMESTAMP);
      break;
    }
    case LIST: {
      protoType.set_kind(facebook::velox::dwrf::proto::orc::Type_Kind_LIST);
      break;
    }
    case MAP: {
      protoType.set_kind(facebook::velox::dwrf::proto::orc::Type_Kind_MAP);
      break;
    }
    case STRUCT: {
      protoType.set_kind(facebook::velox::dwrf::proto::orc::Type_Kind_STRUCT);
      break;
    }
    case UNION: {
      protoType.set_kind(facebook::velox::dwrf::proto::orc::Type_Kind_UNION);
      break;
    }
    case DECIMAL: {
      protoType.set_kind(facebook::velox::dwrf::proto::orc::Type_Kind_DECIMAL);
      break;
    }
    case DATE: {
      protoType.set_kind(facebook::velox::dwrf::proto::orc::Type_Kind_DATE);
      break;
    }
    case VARCHAR: {
      protoType.set_kind(facebook::velox::dwrf::proto::orc::Type_Kind_VARCHAR);
      break;
    }
    case CHAR: {
      protoType.set_kind(facebook::velox::dwrf::proto::orc::Type_Kind_CHAR);
      break;
    }
    default:
  ...
  facebook::velox::dwrf::proto::orc::CompressionKind WriterImpl::convertCompressionKind(
                                      const CompressionKind& kind) {
    return static_cast<facebook::velox::dwrf::proto::orc::CompressionKind>(kind);
  }
