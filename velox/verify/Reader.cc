...
namespace orc {
  ...
  uint64_t getCompressionBlockSize(const facebook::velox::dwrf::proto::orc::PostScript& ps) {
  ...
  CompressionKind convertCompressionKind(const facebook::velox::dwrf::proto::orc::PostScript& ps) {
  ...
  RowReaderImpl::RowReaderImpl(std::shared_ptr<FileContents> _contents,
    ...
    for(size_t i=0; i < numberOfStripes; ++i) {
      ...
      facebook::velox::dwrf::proto::orc::StripeInformation stripeInfo =
  ...
  facebook::velox::dwrf::proto::orc::StripeFooter getStripeFooter(const facebook::velox::dwrf::proto::orc::StripeInformation& info,
    ...
    std::unique_ptr<SeekableInputStream> pbStream =
      createDecompressor(contents.compression,
                         ...
                         contents.blockSize,
                         *contents.pool);
    facebook::velox::dwrf::proto::orc::StripeFooter result;
  ...
  std::string ReaderImpl::getSerializedFileTail() const {
    facebook::velox::dwrf::proto::orc::FileTail tail;
    facebook::velox::dwrf::proto::orc::PostScript *mutable_ps = tail.mutable_postscript();
    mutable_ps->CopyFrom(*contents->postscript);
    facebook::velox::dwrf::proto::orc::Footer *mutableFooter = tail.mutable_footer();
  ...
  void ReaderImpl::getRowIndexStatistics(const facebook::velox::dwrf::proto::orc::StripeInformation& stripeInfo,
      uint64_t stripeIndex, const facebook::velox::dwrf::proto::orc::StripeFooter& currentStripeFooter,
      std::vector<std::vector<facebook::velox::dwrf::proto::orc::ColumnStatistics> >* indexStats) const {
    ...
    for (int i = 0; i < num_streams; i++) {
      const facebook::velox::dwrf::proto::orc::Stream& stream = currentStripeFooter.streams(i);
      ...
      if (static_cast<StreamKind>(stream.kind()) == StreamKind::StreamKind_ROW_INDEX) {
        ...
        facebook::velox::dwrf::proto::orc::RowIndex rowIndex;
        ...
        for (int j = 0; j < num_entries; j++) {
          const facebook::velox::dwrf::proto::orc::RowIndexEntry& entry = rowIndex.entry(j);
  ...
  ReaderImpl::getStripeStatistics(uint64_t stripeIndex) const {
    ...
    std::vector<std::vector<facebook::velox::dwrf::proto::orc::ColumnStatistics> > indexStats(num_cols);

    facebook::velox::dwrf::proto::orc::StripeInformation currentStripeInfo =
        footer->stripes(static_cast<int>(stripeIndex));
    facebook::velox::dwrf::proto::orc::StripeFooter currentStripeFooter =
  ...
  ReaderImpl::getColumnStatistics(uint32_t index) const {
    ...
    facebook::velox::dwrf::proto::orc::ColumnStatistics col =
    ...
    if (metadataSize != 0) {
      std::unique_ptr<SeekableInputStream> pbStream =
        createDecompressor(contents->compression,
                           ...
                           contents->blockSize,
                           *contents->pool);
      metadata.reset(new facebook::velox::dwrf::proto::orc::Metadata());
  ...
  uint64_t maxStreamsForType(const facebook::velox::dwrf::proto::orc::Type& type) {
    switch (static_cast<int64_t>(type.kind())) {
      case facebook::velox::dwrf::proto::orc::Type_Kind_STRUCT:
        return 1;
      case facebook::velox::dwrf::proto::orc::Type_Kind_INT:
      case facebook::velox::dwrf::proto::orc::Type_Kind_LONG:
      case facebook::velox::dwrf::proto::orc::Type_Kind_SHORT:
      case facebook::velox::dwrf::proto::orc::Type_Kind_FLOAT:
      case facebook::velox::dwrf::proto::orc::Type_Kind_DOUBLE:
      case facebook::velox::dwrf::proto::orc::Type_Kind_BOOLEAN:
      case facebook::velox::dwrf::proto::orc::Type_Kind_BYTE:
      case facebook::velox::dwrf::proto::orc::Type_Kind_DATE:
      case facebook::velox::dwrf::proto::orc::Type_Kind_LIST:
      case facebook::velox::dwrf::proto::orc::Type_Kind_MAP:
      case facebook::velox::dwrf::proto::orc::Type_Kind_UNION:
        return 2;
      case facebook::velox::dwrf::proto::orc::Type_Kind_BINARY:
      case facebook::velox::dwrf::proto::orc::Type_Kind_DECIMAL:
      case facebook::velox::dwrf::proto::orc::Type_Kind_TIMESTAMP:
        return 3;
      case facebook::velox::dwrf::proto::orc::Type_Kind_CHAR:
      case facebook::velox::dwrf::proto::orc::Type_Kind_STRING:
      case facebook::velox::dwrf::proto::orc::Type_Kind_VARCHAR:
        return 4;
      default:
          return 0;
      }
  ...
  uint64_t ReaderImpl::getMemoryUse(int stripeIx, std::vector<bool>& selectedColumns) {
    ...
    for (int i=0; !hasStringColumn && i < footer->types_size(); i++) {
      if (selectedColumns[static_cast<size_t>(i)]) {
        const facebook::velox::dwrf::proto::orc::Type& type = footer->types(i);
   ...
   */
  std::unique_ptr<facebook::velox::dwrf::proto::orc::PostScript> readPostscript(InputStream *stream,
                                                    DataBuffer<char> *buffer,
    ...
    std::unique_ptr<facebook::velox::dwrf::proto::orc::PostScript> postscript =
      std::unique_ptr<facebook::velox::dwrf::proto::orc::PostScript>(new facebook::velox::dwrf::proto::orc::PostScript());
   ...
   * when we convert the facebook::velox::dwrf::proto::orc::Types to TypeImpls.
   */
  void checkProtoTypeIds(const facebook::velox::dwrf::proto::orc::Footer &footer) {
    std::stringstream msg;
   ...
   */
  std::unique_ptr<facebook::velox::dwrf::proto::orc::Footer> readFooter(InputStream* stream,
                                            const DataBuffer<char> *buffer,
                                            uint64_t footerOffset,
                                            const facebook::velox::dwrf::proto::orc::PostScript& ps,
    ...
    std::unique_ptr<facebook::velox::dwrf::proto::orc::Footer> footer =
      std::unique_ptr<facebook::velox::dwrf::proto::orc::Footer>(new facebook::velox::dwrf::proto::orc::Footer());
  ...
  std::unique_ptr<Reader> createReader(std::unique_ptr<InputStream> stream,
    ...
    if (serializedFooter.length() != 0) {
      ...
      contents->postscript.reset(new facebook::velox::dwrf::proto::orc::PostScript(tail.postscript()));
      contents->footer.reset(new facebook::velox::dwrf::proto::orc::Footer(tail.footer()));
