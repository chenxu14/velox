...
namespace orc {
  ...
  StatisticsImpl::StatisticsImpl(const facebook::velox::dwrf::proto::orc::StripeStatistics& stripeStats,
                                 const StatContext& statContext) {
  ...
  StatisticsImpl::StatisticsImpl(const facebook::velox::dwrf::proto::orc::Footer& footer,
                                 const StatContext& statContext) {
  ...
  ColumnStatisticsImpl::ColumnStatisticsImpl
  (const facebook::velox::dwrf::proto::orc::ColumnStatistics& pb) {
    _stats.setNumberOfValues(pb.numberofvalues());
    _stats.setHasNull(pb.hasnull());
  }

  BinaryColumnStatisticsImpl::BinaryColumnStatisticsImpl
  (const facebook::velox::dwrf::proto::orc::ColumnStatistics& pb, const StatContext& statContext){
    _stats.setNumberOfValues(pb.numberofvalues());
    _stats.setHasNull(pb.hasnull());
  ...
  (const facebook::velox::dwrf::proto::orc::ColumnStatistics& pb, const StatContext& statContext){
    ...
    if (pb.has_decimalstatistics() && statContext.correctStats) {
      const facebook::velox::dwrf::proto::orc::DecimalStatistics& stats = pb.decimalstatistics();
  ...
  (const facebook::velox::dwrf::proto::orc::ColumnStatistics& pb){
    ...
    if (!pb.has_doublestatistics()) {
      ...
      const facebook::velox::dwrf::proto::orc::DoubleStatistics& stats = pb.doublestatistics();
      _stats.setHasMinimum(stats.has_minimum());
      _stats.setHasMaximum(stats.has_maximum());
      _stats.setHasSum(stats.has_sum());
  ...
  (const facebook::velox::dwrf::proto::orc::ColumnStatistics& pb){
    ...
    if (!pb.has_intstatistics()) {
      ...
      const facebook::velox::dwrf::proto::orc::IntegerStatistics& stats = pb.intstatistics();
      _stats.setHasMinimum(stats.has_minimum());
      _stats.setHasMaximum(stats.has_maximum());
      _stats.setHasSum(stats.has_sum());
  ...
  (const facebook::velox::dwrf::proto::orc::ColumnStatistics& pb, const StatContext& statContext){
    ...
    if (!pb.has_stringstatistics() || !statContext.correctStats) {
      ...
      const facebook::velox::dwrf::proto::orc::StringStatistics& stats = pb.stringstatistics();
      _stats.setHasMinimum(stats.has_minimum());
      _stats.setHasMaximum(stats.has_maximum());
  ...
  (const facebook::velox::dwrf::proto::orc::ColumnStatistics& pb, const StatContext& statContext) {
    ...
    if (!pb.has_timestampstatistics() || !statContext.correctStats) {
      ...
      const facebook::velox::dwrf::proto::orc::TimestampStatistics& stats = pb.timestampstatistics();
