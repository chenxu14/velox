  ...
  */
  ...
  class ReaderImpl : public Reader {
   private:
    ...
    void getRowIndexStatistics(const facebook::velox::dwrf::proto::orc::StripeInformation& stripeInfo, uint64_t stripeIndex,
                               const facebook::velox::dwrf::proto::orc::StripeFooter& currentStripeFooter,
                               std::vector<std::vector<facebook::velox::dwrf::proto::orc::ColumnStatistics> >* indexStats) const;

    // metadata
    mutable std::unique_ptr<facebook::velox::dwrf::proto::orc::Metadata> metadata;
   ...
   public:
    ...
    const facebook::velox::dwrf::proto::orc::PostScript* getPostscript() const {return contents->postscript.get();}

    uint64_t getBlockSize() const {return contents->blockSize;}

    const facebook::velox::dwrf::proto::orc::Footer* getFooter() const {return contents->footer.get();}
