...
namespace orc {
  ...
  */
  ...
  private:
    ...
    const facebook::velox::dwrf::proto::orc::StripeInformation& stripeInfo;
    const facebook::velox::dwrf::proto::orc::StripeFooter& footer;
  ...
  public:
    ...
    virtual facebook::velox::dwrf::proto::orc::ColumnEncoding getEncoding(uint64_t columnId
                                              ) const override;
  ...
  */
  ...
  public:
    StreamInformationImpl(uint64_t _offset,
                          const facebook::velox::dwrf::proto::orc::Stream& stream
 ...
 */
  ...
  class StripeInformationImpl : public StripeInformation {
    ...
    uint64_t blockSize;
    mutable std::unique_ptr<facebook::velox::dwrf::proto::orc::StripeFooter> stripeFooter;
