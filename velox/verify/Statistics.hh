 ...
 */
  ...
  public:
    ...
    virtual void toProtoBuf(facebook::velox::dwrf::proto::orc::ColumnStatistics& pbStats) const = 0;
  };
 ...
 */
  ...
  public:
    ...
    ColumnStatisticsImpl(const facebook::velox::dwrf::proto::orc::ColumnStatistics& stats);
    ...
    void toProtoBuf(facebook::velox::dwrf::proto::orc::ColumnStatistics& pbStats) const override {
  ...
  public:
    ...
    BinaryColumnStatisticsImpl(const facebook::velox::dwrf::proto::orc::ColumnStatistics& stats,
    ...
    void toProtoBuf(facebook::velox::dwrf::proto::orc::ColumnStatistics& pbStats) const override {
      ...
      facebook::velox::dwrf::proto::orc::BinaryStatistics* binStats = pbStats.mutable_binarystatistics();
  ...
  public:
    ...
    BooleanColumnStatisticsImpl(const facebook::velox::dwrf::proto::orc::ColumnStatistics& stats,
                                const StatContext& statContext);
    ...
    void toProtoBuf(facebook::velox::dwrf::proto::orc::ColumnStatistics& pbStats) const override {
      ...
      facebook::velox::dwrf::proto::orc::BucketStatistics* bucketStats = pbStats.mutable_bucketstatistics();
      if (_hasCount) {
  ...
  public:
    ...
    DateColumnStatisticsImpl(const facebook::velox::dwrf::proto::orc::ColumnStatistics& stats,
                             const StatContext& statContext);
    ...
    void toProtoBuf(facebook::velox::dwrf::proto::orc::ColumnStatistics& pbStats) const override {
      ...
      if (_stats.hasMinimum()) {
        facebook::velox::dwrf::proto::orc::DateStatistics* dateStatistics =
  ...
  public:
    ...
    DecimalColumnStatisticsImpl(const facebook::velox::dwrf::proto::orc::ColumnStatistics& stats,
                                const StatContext& statContext);
    ...
    void toProtoBuf(facebook::velox::dwrf::proto::orc::ColumnStatistics& pbStats) const override {
      ...
      facebook::velox::dwrf::proto::orc::DecimalStatistics* decStats = pbStats.mutable_decimalstatistics();
      if (_stats.hasMinimum()) {
  ...
  public:
    ...
    DoubleColumnStatisticsImpl(const facebook::velox::dwrf::proto::orc::ColumnStatistics& stats);
    ...
    void toProtoBuf(facebook::velox::dwrf::proto::orc::ColumnStatistics& pbStats) const override {
      ...
      facebook::velox::dwrf::proto::orc::DoubleStatistics* doubleStats = pbStats.mutable_doublestatistics();
      if (_stats.hasMinimum()) {
  ...
  public:
    ...
    IntegerColumnStatisticsImpl(const facebook::velox::dwrf::proto::orc::ColumnStatistics& stats);
    ...
    void toProtoBuf(facebook::velox::dwrf::proto::orc::ColumnStatistics& pbStats) const override {
      ...
      facebook::velox::dwrf::proto::orc::IntegerStatistics* intStats = pbStats.mutable_intstatistics();
      if (_stats.hasMinimum()) {
  ...
  public:
    ...
    StringColumnStatisticsImpl(const facebook::velox::dwrf::proto::orc::ColumnStatistics& stats,
                               const StatContext& statContext);
    ...
    void toProtoBuf(facebook::velox::dwrf::proto::orc::ColumnStatistics& pbStats) const override {
      ...
      facebook::velox::dwrf::proto::orc::StringStatistics* strStats = pbStats.mutable_stringstatistics();
      if (_stats.hasMinimum()) {
  ...
  public:
    ...
    TimestampColumnStatisticsImpl(const facebook::velox::dwrf::proto::orc::ColumnStatistics& stats,
                                  const StatContext& statContext);
    ...
    void toProtoBuf(facebook::velox::dwrf::proto::orc::ColumnStatistics& pbStats) const override {
      ...
      if (_stats.hasMinimum()) {
        facebook::velox::dwrf::proto::orc::TimestampStatistics* tsStats =
  ...
  ColumnStatistics* convertColumnStatistics(const facebook::velox::dwrf::proto::orc::ColumnStatistics& s,
                                            const StatContext& statContext);
  ...
  public:
    StatisticsImpl(const facebook::velox::dwrf::proto::orc::StripeStatistics& stripeStats,
                   const StatContext& statContext);

    StatisticsImpl(const facebook::velox::dwrf::proto::orc::Footer& footer, const StatContext& statContext);
  ...
  public:
    StripeStatisticsImpl(
                const facebook::velox::dwrf::proto::orc::StripeStatistics& stripeStats,
                std::vector<std::vector<facebook::velox::dwrf::proto::orc::ColumnStatistics> >& indexStats,
                const StatContext& statContext);
