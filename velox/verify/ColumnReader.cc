...
namespace orc {
  ...
  inline RleVersion convertRleVersion(facebook::velox::dwrf::proto::orc::ColumnEncoding_Kind kind) {
    switch (static_cast<int64_t>(kind)) {
    case facebook::velox::dwrf::proto::orc::ColumnEncoding_Kind_DIRECT:
    case facebook::velox::dwrf::proto::orc::ColumnEncoding_Kind_DICTIONARY:
      return RleVersion_1;
    case facebook::velox::dwrf::proto::orc::ColumnEncoding_Kind_DIRECT_V2:
    case facebook::velox::dwrf::proto::orc::ColumnEncoding_Kind_DICTIONARY_V2:
      return RleVersion_2;
    default:
  ...
  ColumnReader::ColumnReader(const Type& type,
    ...
    std::unique_ptr<SeekableInputStream> stream =
      stripe.getStream(columnId, facebook::velox::dwrf::proto::orc::Stream_Kind_PRESENT, true);
    if (stream.get()) {
  ...
  BooleanColumnReader::BooleanColumnReader(const Type& type,
    ...
    std::unique_ptr<SeekableInputStream> stream =
        stripe.getStream(columnId, facebook::velox::dwrf::proto::orc::Stream_Kind_DATA, true);
    if (stream == nullptr)
  ...
  TimestampColumnReader::TimestampColumnReader(const Type& type,
    ...
    stream = stripe.getStream(columnId, facebook::velox::dwrf::proto::orc::Stream_Kind_SECONDARY, true);
    if (stream == nullptr)
  ...
  DoubleColumnReader::DoubleColumnReader(const Type& type,
                                         StripeStreams& stripe
                                            ...
                                            bufferEnd(nullptr) {
    inputStream = stripe.getStream(columnId, facebook::velox::dwrf::proto::orc::Stream_Kind_DATA, true);
  ...
  StringDictionaryColumnReader::StringDictionaryColumnReader
    ...
    stream = stripe.getStream(columnId, facebook::velox::dwrf::proto::orc::Stream_Kind_LENGTH, false);
    ...
    std::unique_ptr<SeekableInputStream> blobStream =
        stripe.getStream(columnId, facebook::velox::dwrf::proto::orc::Stream_Kind_DICTIONARY_DATA, false);
  ...
  StringDirectColumnReader::StringDirectColumnReader
    ...
    RleVersion rleVersion = convertRleVersion(stripe.getEncoding(columnId)
                                                .kind());
    std::unique_ptr<SeekableInputStream> stream =
        stripe.getStream(columnId, facebook::velox::dwrf::proto::orc::Stream_Kind_LENGTH, true);
    if (stream == nullptr)
    ...
    blobStream = stripe.getStream(columnId, facebook::velox::dwrf::proto::orc::Stream_Kind_DATA, true);
  ...
  Decimal64ColumnReader::Decimal64ColumnReader(const Type& type,
    ...
    valueStream = stripe.getStream(columnId, facebook::velox::dwrf::proto::orc::Stream_Kind_DATA, true);
    ...
    RleVersion vers = convertRleVersion(stripe.getEncoding(columnId).kind());
    std::unique_ptr<SeekableInputStream> stream =
        stripe.getStream(columnId, facebook::velox::dwrf::proto::orc::Stream_Kind_SECONDARY, true);
    if (stream == nullptr)
